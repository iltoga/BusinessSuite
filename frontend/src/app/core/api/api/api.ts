...
export const APIS = [ApiTokenAuthService, BackupsService, ComputeService, CountryCodesService, CustomerApplicationsService, CustomersService, DashboardStatsService, DocumentOcrService, DocumentTypesService, DocumentsService, InvoicesService, LettersService, MockService, OcrService, PaymentsService, ProductsService, ServerManagementService, UserProfileService, UserSettingsService, V1Service];
