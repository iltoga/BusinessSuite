...
def seed_admin_menus(apps, schema_editor):
    ...
    admin_menus = [
        "admin", "admin-document-types", "admin-ai-models", "admin-holidays", 
        "admin-notifications", "admin-backups", "admin-server", 
        "admin-application-settings", "admin-system-costs"
    ]
    ...
    if admin_group:
        admin_visible_menus = [
            "admin", "admin-document-types", "admin-holidays", "admin-notifications",
            "admin-backups", "admin-server", "admin-application-settings", "admin-system-costs"
        ]
