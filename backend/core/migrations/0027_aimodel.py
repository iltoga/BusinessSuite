...
INITIAL_MODELS = [
    ...
    ("openrouter", "google/gemini-2.0-flash-lite-001", "Gemini 2.0 Flash Lite", "Google Gemini 2.0 Flash Lite", True, True, True),
    ...
    ("openrouter", "mistralai/mistral-small-3.2-24b-instruct", "Mistral Small 3.2", "Mistral AI Small 3.2 24B", False, False, True),
    ("openrouter", "google/gemini-2.5-flash-lite", "Gemini 2.5 Flash Lite", "Google Gemini 2.5 Flash Lite", True, True, True),
    ("openrouter", "google/gemini-2.5-flash", "Gemini 2.5 Flash", "Google Gemini 2.5 Flash", True, True, True),
    ("openrouter", "google/gemini-3-flash-preview", "Gemini 3 Flash Preview", "Google Gemini 3 Flash Preview", True, True, True),
    ...
    ("groq", "meta-llama/llama-4-scout-17b-16e-instruct", "Llama 4 Scout 17B", "Meta Llama 4 Scout via Groq", True, False, True),
    ("groq", "meta-llama/llama-4-maverick-17b-128e-instruct", "Llama 4 Maverick 17B", "Meta Llama 4 Maverick via Groq", True, False, True),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("provider", models.CharField(choices=[("openrouter", "OpenRouter"), ("openai", "OpenAI"), ("groq", "Groq")], db_index=True, max_length=32)),
                ...
                ("prompt_price_per_token", models.DecimalField(blank=True, decimal_places=12, max_digits=20, null=True)),
                ("completion_price_per_token", models.DecimalField(blank=True, decimal_places=12, max_digits=20, null=True)),
        ...
        migrations.AddConstraint(
            model_name="aimodel",
            constraint=models.UniqueConstraint(fields=("provider", "model_id"), name="core_aimodel_provider_model_id_uniq"),
        ),
