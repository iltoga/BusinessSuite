"""Add invoice document job and item models for document workflows."""
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "format_type",
                    models.CharField(choices=[("docx", "DOCX"), ("pdf", "PDF")], default="docx", max_length=10),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="items",
                        to="invoices.invoicedocumentjob",
                    ),
                ),
            ],
            options={
