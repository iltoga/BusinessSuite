...
class ApplicationCalendarService:
    ...
    def _build_calendar_event_payload(self, application, task, due_date):
        ...
        return {
            ...
            "extended_properties": {"private": self._private_properties(application, task)},
        }
    ...
    def _private_properties(self, application, task):
        return {
            self.PRIVATE_PROP_ENTITY_KEY: self.PRIVATE_PROP_ENTITY_VALUE,
            self.PRIVATE_PROP_APPLICATION_ID_KEY: str(application.id),
            self.PRIVATE_PROP_TASK_ID_KEY: str(task.id),
            self.PRIVATE_PROP_TASK_STEP_KEY: str(task.step),
        }
