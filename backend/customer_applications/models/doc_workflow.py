...
class DocWorkflow(models.Model):
    ...
    created_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.PROTECT, related_name="created_by_doc_workflow"
    )
    ...
    def calculate_workflow_due_date(self):
        business_days = self.task.duration_is_business_days
        duration = self.task.duration
        due_date = calculate_due_date(self.start_date, duration, business_days)
        return due_date
