...
KEY_COMPONENTS:
- _build_archive: Private helper.
- _build_zst_archive: Private helper.
- BackupSerializationTests: Module symbol.
- RestoreFixtureSanitizationUnitTests: Module symbol.
- RestoreCompatibilityTests: Module symbol.
