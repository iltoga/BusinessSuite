...
(function (currencyDecimalPlaces, customerApplications, maskedUrlNewInvoice) {
    $(document).ready(function () {
        checkSelected();
        setFormsetFieldsEditable(false);
    });
    ...
    document.getElementById('add-invoiceapplication').addEventListener('click', function () {
        ...
        $('[name^=invoice_applications-' + formIdx + '-due_amount]').prop('disabled', false);
    });
    ...
    function setFormsetFieldsEditable(isEditable) {
        $('[name^=invoice_applications-][name$=-customer_application]').each(function () {
            $(this).prop('disabled', !isEditable);
        });
        $('[name^=invoice_applications-][name$=-due_amount]').each(function () {
            $(this).prop('disabled', !isEditable);
        });
    }
