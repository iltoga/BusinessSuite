...
script.onload = function () {
    $(document).ready(function () {
        ...
        doc_type_selector.change(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    product_selector.change();  // trigger change event to refresh documents
                }
            });
        });
        ...
        product_selector.change(function () {
            ...
            $.ajax({
                url: '/api/products/get_product_by_id/',  // the url of your Django view that returns a list of documents
                data: {
